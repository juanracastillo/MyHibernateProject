package com.allinone.myproject.northwind.dao;
 ...
 * @see com.allinone.myproject.northwind.dao.Employees
	...
	public Employees findById(java.lang.Integer id) {
		...
		try {
			Employees instance = (Employees) sessionFactory.getCurrentSession()
					.get("com.allinone.myproject.northwind.dao.Employees", id);
			if (instance == null) {
	...
	public List<?> findByExample(Employees instance) {
		...
		try {
			List<?> results = sessionFactory.getCurrentSession()
					.createCriteria("com.allinone.myproject.northwind.dao.Employees").add(Example.create(instance))
					.list();
